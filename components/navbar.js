document.addEventListener("DOMContentLoaded", () => {
    ...
    // Đoạn HTML Navigation Bar
    const navHTML = `
    <nav class="bg-slate-950/50 backdrop-blur-md border-b border-slate-800/80 sticky top-0 z-50 px-4 py-3 shadow-lg shadow-cyan-500/10">
        <div class="max-w-6xl mx-auto flex items-center justify-between">
            ...
            <div class="hidden md:flex items-center gap-6">
                <a href="index.html" class="text-sm font-semibold transition-colors py-1 ${!isScannerPage ? 'text-cyan-400 border-b-2 border-cyan-500' : 'text-slate-300 hover:text-cyan-400'}">
                    Bảng Điều Khiển
                </a>
                <a href="index.html#camera-section" class="text-sm font-semibold text-slate-300 hover:text-cyan-400 transition-colors py-1">
                    Live Camera
                </a>
                <a href="Mode.html" class="text-sm font-semibold text-slate-300 hover:text-cyan-400 transition-colors py-1">
                    Chế độ
                </a>
            ...
            <div class="flex items-center gap-3">
                <span class="px-2.5 py-1 rounded-full text-xs font-semibold bg-cyan-500/10 text-cyan-400 border border-cyan-500/20 flex items-center gap-1">
